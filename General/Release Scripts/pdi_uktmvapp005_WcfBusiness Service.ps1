...
Write-Host "WCF Business Service UAT Deployment Process Started $lineBreak" -foregroundcolor "DarkRed" -backgroundcolor "white"
...
$releaseArea="\\USPMVIFM013\\dfs\\DATA\\Informationtechnology\\UKDC\\Releases\\Release Components\\WCFBusinessService"
...
$targetServer="UKTMVAPP005"

#$targetServer=inputFromUser -p1 $targetServer -p2 "target server"


$targetIIsWebsite="WCFBusinessService"
...
$from="\\$targetServer\\c$\\inetpub\UserServices\\$targetIIsWebsite\\*"
